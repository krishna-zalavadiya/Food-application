...
const About = () => {
    ...
    return(
        ...
        overflow-hidden relative'>
            ...
            className='py-16 px-4 test-center relative'>
            <div className='max-w-4xl mx-auto'>
                <motion.h1 className='text-5xl sm:6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text text-transparent
                    ...
                    {features.map((f,i) =>{
                        ...
                        return (
                            ...
                            transition={{delay: i*0.2}} className='relative group'>
                                ...
                                <div className='relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3x1 overflow-hidden
                                border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full'>
                                    ...
                                    <div className='p-8'>
                                         ...
                                         <p className='text-amber-100/100'>{f.text}</p>
                                    </div>
                                </div>
                            </motion.div>
                        )
            ...
            <section className='py16 px-4 px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90'>
                    <div className='mx-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
                        {stats.map((s,i) => {
                            const Icon=s.icon
                            return(
                                ...
                                animate={{
                                    ...
                                    <motion.div className='absolute inset-0' animate={{
                                        y:[0,-15,0],
                                        transition: {
                                            duration: 4,reapeat:Infinity, ease:'easeInOut',
                                            delay:i*0.3
                                        }
                                    }}>
                                        ...
                                        rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300'>
                                            ...
                                            animate={{
                                                background: [
                                                    ...
                                                    'linear-grandient(45deg, #3c2a21 0% #1a120b 50% #3c2a21 100%)',
                                                    'linear-grandient(45deg, #3c2a21 0% #1a120b 50% #3c2a21 100%)',
                                                    'linear-grandient(45deg, #3c2a21 0% #1a120b 50% #3c2a21 100%)'
                                                ]
                                            ...
                                            <div className='absolute inset-0 rounded-xl shadow-1g
                                            shadow-amber-900/20'/>
            ...
            <section className='py-16 px-4 md:px-8 relative'>
                <div className='max-v-7xl mx-auto'>
                    ...
                    className='text 4xl font-serif sm:text-5xl md:text-6xl font-bold text-center mb-12 text-amber-100'>
                        Meet Our <span className='text-amber-50'>Culinary Artists</span>
                    </motion.h2>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12'>
                        {teamMembers.map((m,i) => (
                            ...
                            transition={{delay: m.delay}} className='relative group'>
                                ...
                                border-2 border-amber-600/30 hover:border-amber-500 transtion-all duration-500 shadow-xl
                                hover:shadow-2xl hover:shadow-amber-500/20'>
                                    <div className='relative h-64 sm:h-72 md:h-96 overflow-hidden'>
                                        <motion.img src={m.img} alt={m.name} className='w-full h-full object-cover' initial={{ scale: 1 }} 
                                        ...
                                        <div className='p-8 text-center flex flex-col h-[calc(100%-24rem)]'>
                                            ...
                                            <motion.div className='flext justify-center gap-4 pt-6' initial={{scale: 0}}
                                            whileInView={{scale: 1}}>
                                            {
