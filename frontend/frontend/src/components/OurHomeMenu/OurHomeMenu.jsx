                  ...
                  <div className='flex items-center gap-2'>
                    {quantity > 0 ? (
                      <>
                        ...
                        <button className='w-8 h-8 rounded-full bg-amber-900/40 flex items-center
                        justify-center hover:bg-amber-800/50 transition-colors' onClick={()=> addToCart(item,quantity +1)}>
                      ...
                      font-cinzel text-xs uppercase sm:text-sm tracking-wider transition-transform duration
