            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <p className='text-amber-200/90 text-sm font-sacremnto italic'>
                            When culinary artistry meets doorstep convinience. <br />
                            Savour handcrafted perfection, delivered with care.
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className='relative mt-4 group'>
                            ...
                            <div className='relative'>
                                ...
                                focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 p-24'
                                required />
                                ...
                                flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transtion-all duration-500'>
                                    ...
                                    flex-shrink-0'/>
                                    <span className='absolute inset-8 -translate-x-full bg-gradient-to-r from-transparent
                    ...
                    <div className='flex justify-center'>
                        <div className='space-y-4'>
                            ...
                            <ul className='space-y-3'>
                                {navItems.map(item => (
                                    <li key={item.name}>
                                        <a href={item.link} className='flex items-center hover:amber-400
                ...
                <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                    <p className='text-amber-400 text-lg mb-2 font-playfair'>
                        &copy; 2025 Urban Plates. All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
