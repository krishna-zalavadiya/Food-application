      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-full max-h-full">
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 bg-amber-900/80 rounded-full p-2 text-black hover:bg-amber-800/90 transition-transform duration-200 active:scale-90"
            >
              <FaTimes className="w-6 h-6 text-amber-100" />
            </button>
          </div>
        </div>
      )}
